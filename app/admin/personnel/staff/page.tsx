...
export default async function AdminStaffPage() {
  const accounts = await getAccountsByRole(["INVENTORY", "DELIVERY"]);
    ...
    <div className="space-y-6 p-8">
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-amber-900">Staff Personnel</h1>
          <p className="text-amber-700">Manage Inventory and Delivery accounts</p>
        </div>
        <Link 
          href="/admin/personnel/staff/create-account"
