...
export default async function AdminHRPage() {
  const accounts = await getAccountsByRole("HR");
    ...
    <div className="space-y-6 p-8">
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-amber-900">HR Personnel</h1>
          <p className="text-amber-700">Manage Human Resource accounts</p>
        </div>
        <Link 
